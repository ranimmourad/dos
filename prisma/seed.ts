...
async function main() {
  ...
  await prisma.product.create({
    data: {
      ...
      published: true,
      categoryId: cat.id,
      images: { create: [{ url: "https://placehold.co/600x800/111111/ffffff?text=D.O.S+Hoodie", order: 0 }] },
  ...
  await prisma.product.create({
    data: {
      ...
      published: true,
      categoryId: cat.id,
      images: { create: [{ url: "https://placehold.co/600x800/f5f5f5/111111?text=D.O.S+Tee", order: 0 }] },
